...
enum {
  ...
  aux_sym_variable_definition_repeat1 = 57,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [13] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(24),
  [16] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(25),
  [19] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(25),
  [22] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 1),
  [24] = {.entry = {.count = 1, .reusable = true}}, SHIFT(30),
  [26] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_field_list_repeat1, 2),
  [28] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_field_list_repeat1, 2), SHIFT_REPEAT(25),
  [31] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_field_list_repeat1, 2), SHIFT_REPEAT(25),
  [34] = {.entry = {.count = 1, .reusable = true}}, SHIFT(26),
  [36] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field_list, 3),
  [38] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_field_list, 3),
  [40] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct_definition, 3, .production_id = 1),
  [42] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_struct_definition, 3, .production_id = 1),
  [44] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_definition, 3),
  [46] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_variable_definition, 3),
  [48] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_definition, 4),
  [50] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_variable_definition, 4),
  [52] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field_list, 4),
  [54] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_field_list, 4),
  ...
  [68] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_variable_definition_repeat1, 2), SHIFT_REPEAT(29),
  ...
  [85] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_variable_definition_repeat1, 2),
